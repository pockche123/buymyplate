...
CREATE TABLE vehicle_plates (
                               ...
                               user_id    INTEGER,
                               CONSTRAINT fk_vehicle_plate_user
...
CREATE TABLE transactions (
                             ...
                             CONSTRAINT fk_tx_vehicle_plate
                                 FOREIGN KEY (vehicle_plate_id)  REFERENCES vehicle_plates(plate_id)
);

CREATE TABLE balances (
                         balance_id   INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
INSERT INTO vehicle_plates (plate_number, personalised, available, price, user_id) VALUES
-- Personalised Plates
...
INSERT INTO transactions (user_id, vehicle_plate_id, price_paid, transaction_date) VALUES
...
INSERT INTO balances (amount, user_id) VALUES (1250.75, 1);
INSERT INTO balances (amount, user_id) VALUES ( 320.00, 2);
INSERT INTO balances (amount, user_id) VALUES (9875.10, 3);
INSERT INTO balances (amount, user_id) VALUES (   0.00, 4);
INSERT INTO balances (amount, user_id) VALUES (  56.42, 5);
