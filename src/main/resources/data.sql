...
-- TRANSACTION TABLE
-- (Note: “transaction” is a SQL keyword in Postgres; if you hit a name conflict,
--  either quote it: "transaction", or rename to transactions.)
...
INSERT INTO customer (id, username, password, first_name, last_name) VALUES
                                                                         (1, 'jdoe', 'password123', 'John', 'Doe'),
                                                                         (2, 'asmith', 'secret456', 'Alice', 'Smith'),
                                                                         (3, 'bwayne', 'darkknight', 'Bruce', 'Wayne'),
                                                                         (4, 'ckent', 'superman', 'Clark', 'Kent'),
                                                                         (5, 'dparker', 'sp1derm4n', 'Peter', 'Parker');
